...
if(isset($_POST["submit"]))
{
	...
	if($error == '')
	{
		...
		$mail->Username = 'otakushi02@gmail.com';					//Sets SMTP username
		$mail->Password = 'ijxgntrtzhwknhir';//otakushi02@php					//Sets SMTP password
		$mail->SMTPSecure = 'tls';							//Sets connection prefix. Options are "", "ssl" or "tls"
		$mail->From = 'otakushi02@gmail.com';					//Sets the From email address for the message
